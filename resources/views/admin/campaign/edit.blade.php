                    ...
                    <form method="POST" action="{{ route('campaigns.update',$campaign) }}" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input id="instruction_two_en" type="text" class="form-control @error('instruction_two_en') is-invalid @enderror" name="instruction_two_en" value="{{ old('instruction_two_en',$campaign->instruction_two_en) }}" autofocus>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="instruction_two_bn" type="text" class="form-control @error('instruction_two_bn') is-invalid @enderror" name="instruction_two_bn" value="{{ old('instruction_two_bn',$campaign->instruction_two_bn) }}" autofocus>
